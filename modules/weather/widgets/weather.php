<?php
namespace Nova_Elements\Modules\Weather\Widgets;
 ...
 * Weather Widget
 */
class Weather extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Weather', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-43';
    }

    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/weather/css-scheme',
            array(
                'title'                 => '.nova-weather__title',
                'current_container'     => '.nova-weather__current',
                'current_temp'          => '.nova-weather__current-temp',
                'current_icon'          => '.nova-weather__current-icon .nova-weather-icon',
                'current_desc'          => '.nova-weather__current-desc',
                'current_details'       => '.nova-weather__details',
                'current_details_item'  => '.nova-weather__details-item',
                'current_details_icon'  => '.nova-weather__details-item .nova-weather-icon',
                'current_day'           => '.nova-weather__current-day',
                'forecast_container'    => '.nova-weather__forecast',
                'forecast_item'         => '.nova-weather__forecast-item',
                'forecast_day'          => '.nova-weather__forecast-day',
                'forecast_icon'         => '.nova-weather__forecast-icon .nova-weather-icon',
            )
        );
        ...
        $this->start_controls_section(
            'section_weather',
            array(
                'label' => esc_html__( 'Weather', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'location',
            array(
                'label'       => esc_html__( 'Location', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => array( 'active' => true, ),
                'placeholder' => esc_html__( 'London, United Kingdom', 'nova-elements' ),
                'default'     => esc_html__( 'London, United Kingdom', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'units',
            array(
                'label'   => esc_html__( 'Units', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'metric',
                'options' => array(
                    'metric'   => esc_html__( 'Metric', 'nova-elements' ),
                    'imperial' => esc_html__( 'Imperial', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'show_country_name',
            array(
                'label'        => esc_html__( 'Show country name', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Show current weather', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'true',
                'default'      => 'true',
                'separator'    => 'before',
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Show current weather details', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'true',
                'condition'    => array(
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Show forecast weather', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'true',
                'separator'    => 'before',
            )
        ...
        $this->add_control(
            'forecast_count',
            array(
                'label' => esc_html__( 'Number of forecast days', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'justify' => array(
                        'title' => esc_html__( 'Justified', 'nova-elements' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Current Weather', 'nova-elements' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'show_current_weather' => 'true',
                ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Container', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Temperature', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Details Weather', 'nova-elements' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'show_current_weather'         => 'true',
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'label'    => esc_html__( 'Day typography', 'nova-elements' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'     => esc_html__( 'Forecast Weather', 'nova-elements' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'show_forecast_weather' => 'true',
                ),
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Divider', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'  => Controls_Manager::SELECT,
                'options' => array(
                    'solid'  => esc_html__( 'Solid', 'nova-elements' ),
                    'double' => esc_html__( 'Double', 'nova-elements' ),
                    'dotted' => esc_html__( 'Dotted', 'nova-elements' ),
                    'dashed' => esc_html__( 'Dashed', 'nova-elements' ),
                ),
                'default' => 'solid',
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Weight', 'nova-elements' ),
                'type'    => Controls_Manager::SLIDER,
                'default' => array(
                    'size' => 1,
                ),
    ...
    public function get_weather_data() {
        ...
        $transient_key = sprintf( 'nova-weather-data-yahoo-%1$s-%2$s', $units, md5( $location ) );
        ...
        if ( ! $data ) {
            ...
            if ( 0 === $request_data['query']['count'] || empty( $request_data['query']['results'] ) || empty( $request_data['query']['results']['channel'] ) ) {
                ...
                $message = esc_html__( 'Weather data of this location not found.', 'nova-elements' );
            ...
            set_transient( $transient_key, $data, apply_filters( 'nova-elements/weather/cached-time', HOUR_IN_SECONDS ) );
        }
    ...
    public function get_weather_desc( $code ) {
        ...
        switch ( $code ) {
            case 0:
                $desc = esc_html_x( 'Tornado', 'Weather description', 'nova-elements' );
                break;
            case 1:
                $desc = esc_html_x( 'Tropical storm', 'Weather description', 'nova-elements' );
                break;
            case 2:
                $desc = esc_html_x( 'Hurricane', 'Weather description', 'nova-elements' );
                break;
            case 3:
                $desc = esc_html_x( 'Severe thunderstorms', 'Weather description', 'nova-elements' );
                break;
            case 4:
                $desc = esc_html_x( 'Thunderstorms', 'Weather description', 'nova-elements' );
                break;
            case 5:
                $desc = esc_html_x( 'Mixed rain and snow', 'Weather description', 'nova-elements' );
                break;
            case 6:
                $desc = esc_html_x( 'Mixed rain and sleet', 'Weather description', 'nova-elements' );
                break;
            case 7:
                $desc = esc_html_x( 'Mixed snow and sleet', 'Weather description', 'nova-elements' );
                break;
            case 8:
                $desc = esc_html_x( 'Freezing drizzle', 'Weather description', 'nova-elements' );
                break;
            case 9:
                $desc = esc_html_x( 'Drizzle', 'Weather description', 'nova-elements' );
                break;
            case 10:
                $desc = esc_html_x( 'Freezing rain', 'Weather description', 'nova-elements' );
                break;
            case 11:
            case 12:
                $desc = esc_html_x( 'Showers', 'Weather description', 'nova-elements' );
                break;
            case 13:
                $desc = esc_html_x( 'Snow flurries', 'Weather description', 'nova-elements' );
                break;
            case 14:
                $desc = esc_html_x( 'Light snow showers', 'Weather description', 'nova-elements' );
                break;
            case 15:
                $desc = esc_html_x( 'Blowing snow', 'Weather description', 'nova-elements' );
                break;
            case 16:
                $desc = esc_html_x( 'Snow', 'Weather description', 'nova-elements' );
                break;
            case 17:
                $desc = esc_html_x( 'Hail', 'Weather description', 'nova-elements' );
                break;
            case 18:
                $desc = esc_html_x( 'Sleet', 'Weather description', 'nova-elements' );
                break;
            case 19:
                $desc = esc_html_x( 'Dust', 'Weather description', 'nova-elements' );
                break;
            case 20:
                $desc = esc_html_x( 'Foggy', 'Weather description', 'nova-elements' );
                break;
            case 21:
                $desc = esc_html_x( 'Haze', 'Weather description', 'nova-elements' );
                break;
            case 22:
                $desc = esc_html_x( 'Smoky', 'Weather description', 'nova-elements' );
                break;
            case 23:
                $desc = esc_html_x( 'Blustery', 'Weather description', 'nova-elements' );
                break;
            case 24:
                $desc = esc_html_x( 'Windy', 'Weather description', 'nova-elements' );
                break;
            case 25:
                $desc = esc_html_x( 'Cold', 'Weather description', 'nova-elements' );
                break;
            case 26:
                $desc = esc_html_x( 'Cloudy', 'Weather description', 'nova-elements' );
                break;
            case 27:
            case 28:
                $desc = esc_html_x( 'Mostly cloudy', 'Weather description', 'nova-elements' );
                break;
            case 29:
            case 30:
                $desc = esc_html_x( 'Partly cloudy', 'Weather description', 'nova-elements' );
                break;
            case 31:
                $desc = esc_html_x( 'Clear', 'Weather description', 'nova-elements' );
                break;
            case 32:
                $desc = esc_html_x( 'Sunny', 'Weather description', 'nova-elements' );
                break;
            case 33:
            case 34:
                $desc = esc_html_x( 'Fair', 'Weather description', 'nova-elements' );
                break;
            case 35:
                $desc = esc_html_x( 'Mixed rain and hail', 'Weather description', 'nova-elements' );
                break;
            case 36:
                $desc = esc_html_x( 'Hot', 'Weather description', 'nova-elements' );
                break;
            case 37:
                $desc = esc_html_x( 'Isolated thunderstorms', 'Weather description', 'nova-elements' );
                break;
            case 38:
            case 39:
                $desc = esc_html_x( 'Scattered thunderstorms', 'Weather description', 'nova-elements' );
                break;
            case 40:
                $desc = esc_html_x( 'Scattered showers', 'Weather description', 'nova-elements' );
                break;
            case 41:
            case 43:
                $desc = esc_html_x( 'Heavy snow', 'Weather description', 'nova-elements' );
                break;
            case 42:
                $desc = esc_html_x( 'Scattered snow showers', 'Weather description', 'nova-elements' );
                break;
            case 44:
                $desc = esc_html_x( 'Partly cloudy', 'Weather description', 'nova-elements' );
                break;
            case 45:
                $desc = esc_html_x( 'Thundershowers', 'Weather description', 'nova-elements' );
                break;
            case 46:
                $desc = esc_html_x( 'Snow showers', 'Weather description', 'nova-elements' );
                break;
            case 47:
                $desc = esc_html_x( 'Isolated thundershowers', 'Weather description', 'nova-elements' );
                break;
            case 3200:
                $desc = esc_html_x( 'Not available', 'Weather description', 'nova-elements' );
                break;
        }
    ...
    public function get_weather_title() {
        ...
        return sprintf( '<%1$s class="nova-weather__title">%2$s</%1$s>', $tag, $title );
    }
    ...
    public function get_weather_temp( $temp ) {
        ...
        $format = apply_filters( 'nova-elements/weather/temperature-format', '%1$s%2$s' );
    ...
    public function get_wind( $speed, $deg ) {
        $units      = $this->get_settings_for_display( 'units' );
        $speed_unit = ( 'metric' === $units ) ? esc_html_x( 'km/h', 'Unit of speed (kilometers/hour)', 'nova-elements' ) : esc_html_x( 'mph', 'Unit of speed (miles/hour)', 'nova-elements' );

        $direction = '';

        if ( ( $deg >= 0 && $deg <= 11.25 ) || ( $deg > 348.75 && $deg <= 360 ) ) {
            $direction = esc_html_x( 'N', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 11.25 && $deg <= 33.75 ) {
            $direction = esc_html_x( 'NNE', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 33.75 && $deg <= 56.25 ) {
            $direction = esc_html_x( 'NE', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 56.25 && $deg <= 78.75 ) {
            $direction = esc_html_x( 'ENE', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 78.75 && $deg <= 101.25 ) {
            $direction = esc_html_x( 'E', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 101.25 && $deg <= 123.75 ) {
            $direction = esc_html_x( 'ESE', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 123.75 && $deg <= 146.25 ) {
            $direction = esc_html_x( 'SE', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 146.25 && $deg <= 168.75 ) {
            $direction = esc_html_x( 'SSE', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 168.75 && $deg <= 191.25 ) {
            $direction = esc_html_x( 'S', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 191.25 && $deg <= 213.75 ) {
            $direction = esc_html_x( 'SSW', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 213.75 && $deg <= 236.25 ) {
            $direction = esc_html_x( 'SW', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 236.25 && $deg <= 258.75 ) {
            $direction = esc_html_x( 'WSW', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 258.75 && $deg <= 281.25 ) {
            $direction = esc_html_x( 'W', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 281.25 && $deg <= 303.75 ) {
            $direction = esc_html_x( 'WNW', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 303.75 && $deg <= 326.25 ) {
            $direction = esc_html_x( 'NW', 'Wind direction', 'nova-elements' );
        } else if ( $deg > 326.25 && $deg <= 348.75 ) {
            $direction = esc_html_x( 'NNW', 'Wind direction', 'nova-elements' );
        }

        $format = apply_filters( 'nova-elements/weather/wind-format', '%1$s %2$s %3$s' );
    ...
    public function get_weather_notice( $message ) {
        return sprintf( '<div class="nova-weather-notice">%s</div>', $message );
    }
    ...
    public function get_weather_svg_icon( $icon ) {
        ...
        $icon_path = NOVA_ELEMENTS_PATH . "assets/images/weather-icons/{$icon}.svg" ;
        ...
        $_classes   = array();
        $_classes[] = 'nova-weather-icon';
        $_classes[] = sprintf( 'nova-weather-icon-%s', esc_attr( $icon ) );
