<?php
namespace Nova_Elements\Modules\Table\Widgets;
 ...
 * Table Widget
 */
class Table extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Table', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-37';
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/table/css-scheme',
            array(
                'wrapper'                 => '.nova-table-wrapper',
                'table'                   => '.nova-table',
                'table_cell'              => '.nova-table__cell',
                'table_head'              => '.nova-table__head',
                'table_head_row'          => '.nova-table__head-row',
                'table_head_cell'         => '.nova-table__head-cell',
                'table_head_cell_inner'   => '.nova-table__head-cell .nova-table__cell-inner',
                'table_head_cell_content' => '.nova-table__head-cell .nova-table__cell-content',
                'table_head_icon'         => '.nova-table__head-cell .nova-table__cell-icon',
                'table_head_icon_before'  => '.nova-table__head-cell .nova-table__cell-icon--before',
                'table_head_icon_after'   => '.nova-table__head-cell .nova-table__cell-icon--after',
                'table_head_img'          => '.nova-table__head-cell .nova-table__cell-img',
                'table_head_img_before'   => '.nova-table__head-cell .nova-table__cell-img--before',
                'table_head_img_after'    => '.nova-table__head-cell .nova-table__cell-img--after',
                'sorting_icon'            => '.nova-table__sort-icon',
                'table_body'              => '.nova-table__body',
                'table_body_row'          => '.nova-table__body-row',
                'table_body_cell'         => '.nova-table__body-cell',
                'table_body_cell_inner'   => '.nova-table__body-cell .nova-table__cell-inner',
                'table_body_cell_content' => '.nova-table__body-cell .nova-table__cell-content',
                'table_body_icon'         => '.nova-table__body-cell .nova-table__cell-icon',
                'table_body_icon_before'  => '.nova-table__body-cell .nova-table__cell-icon--before',
                'table_body_icon_after'   => '.nova-table__body-cell .nova-table__cell-icon--after',
                'table_body_img'          => '.nova-table__body-cell .nova-table__cell-img',
                'table_body_img_before'   => '.nova-table__body-cell .nova-table__cell-img--before',
                'table_body_img_after'    => '.nova-table__body-cell .nova-table__cell-img--after',
                'table_body_cell_link'    => '.nova-table__cell-link',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Table Header', 'nova-elements' ),
            )
        );
        ...
        $table_header_repeater->add_control(
            'add_icon_or_image',
            array(
                'label'   => esc_html__( 'Add icon/image', 'nova-elements' ),
        ...
        $table_header_repeater->add_control(
            'col_span',
            array(
                'label' => esc_html__( 'Column Span', 'nova-elements' ),
        ...
        $table_header_repeater->add_responsive_control(
            'col_width',
            array(
                'label' => esc_html__( 'Column Width', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => array(
                    array(
                        'cell_text' => esc_html__( 'Heading #1', 'nova-elements' ),
                    ),
                    array(
                        'cell_text' => esc_html__( 'Heading #2', 'nova-elements' ),
                    ),
                    array(
                        'cell_text' => esc_html__( 'Heading #3', 'nova-elements' ),
                    ),
                ),
                'title_field' => esc_html__( 'Column: ', 'nova-elements' ) . '{{ cell_text }}',
            )
        );
        ...
        $this->start_controls_section(
            'section_table_body',
            array(
                'label' => esc_html__( 'Table Body', 'nova-elements' ),
            )
        );
        ...
        $table_body_repeater->add_control(
            'action',
            array(
                'label'   => esc_html__( 'Action', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'cell',
                'options' => array(
                    'row'  => esc_html__( 'Start New Row', 'nova-elements' ),
                    'cell' => esc_html__( 'Add New Cell', 'nova-elements' ),
                ),
            )
        );
        ...
        $table_body_repeater->add_control(
            'row_custom_style',
            array(
                'label' => esc_html__( 'Add Custom Style', 'nova-elements' ),
        ...
        $table_body_repeater->add_control(
            ...
            array(
                ...
                'placeholder' => esc_html__( 'https://your-link.com', 'nova-elements' ),
                'condition' => array(
                    'action' => 'cell',
                ),
            )
        ...
        $table_body_repeater->add_control(
            'row_span',
            array(
                'label' => esc_html__( 'Row Span', 'nova-elements' ),
                'type'  => Controls_Manager::NUMBER,
                'min'   => 1,
                'step'  => 1,
                'condition' => array(
        ...
        $table_body_repeater->add_control(
            'cell_is_th',
            array(
                'label' => esc_html__( 'This cell is Table Heading?', 'nova-elements' ),
                'type'  => Controls_Manager::SWITCHER,
                'condition' => array(
                    'action' => 'cell',
                ),
        ...
        $table_body_repeater->add_control(
            'cell_is_th_desc',
            array(
                'raw'  => esc_html__( 'For this cell are applied table heading cell style', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => array(
                    ...
                    array(
                        'action'    => 'cell',
                        'cell_text' => esc_html__( 'Simple content', 'nova-elements' ),
                    ),
                    array(
                        'action'    => 'cell',
                        'cell_text' => esc_html__( 'Simple content', 'nova-elements' ),
                ...
                'title_field' => '{{ action === "row" ? "' . esc_html__( 'Start Row:', 'nova-elements' ) . '" : "' . esc_html__( 'Cell:', 'nova-elements' ) . ' " + cell_text }}',
            )
        );
        ...
        $this->add_control(
            'sorting_table',
            array(
                'label'   => esc_html__( 'Sorting Table', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'responsive_table',
            array(
                'label'   => esc_html__( 'Responsive Table', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'raw'  => esc_html__( 'Responsive table allow table to be scrolled horizontally.', 'nova-elements' ),
                'type' => Controls_Manager::RAW_HTML,
                'content_classes' => 'elementor-descriptor',
                'condition'   => array(
        ...
        $this->add_control(
            'responsive_table_on',
            array(
                'label'       => esc_html__( 'Responsive On', 'nova-elements' ),
                'label_block' => true,
        ...
        $this->add_responsive_control(
            'table_width',
            array(
                'label' => esc_html__( 'Table Width', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'size_units' => array( '%', 'px' ),
                'range' => array(
                    'px' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'fixed' => esc_html__( 'Fixed (Equal width)', 'nova-elements' ),
                ),
                'default' => 'auto',
                'selectors' => array(
        ...
        $this->add_responsive_control(
            'table_align',
            array(
                'label' => esc_html__( 'Table Alignment', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Hidden border for header container', 'nova-elements' ),
                'type'  => Controls_Manager::SWITCHER,
                'selectors'  => array(
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'middle' => array(
                        'title' => esc_html__( 'Middle', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label' => '<b>' . esc_html__( 'Icon', 'nova-elements' ) . '</b>',
        ...
        $this->add_control(
            ...
            array(
                'label' => '<b>' . esc_html__( 'Image', 'nova-elements' ) . '</b>',
                'type'  => Controls_Manager::POPOVER_TOGGLE,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'sorting_icon_style',
            array(
                'label' => '<b>' . esc_html__( 'Sorting Icon', 'nova-elements' ) . '</b>',
                'type'  => Controls_Manager::POPOVER_TOGGLE,
                'separator' => 'before',
                'condition' => array(
                    'sorting_table' => 'yes',
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Background Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Striped rows', 'nova-elements' ),
                'type'  => Controls_Manager::SWITCHER,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Background Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Link Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Hover Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Hover Background Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Hover Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Hover Background Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Cell Hover Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Cell Hover Background Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Link Hover Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Hidden border for body container', 'nova-elements' ),
                'type'  => Controls_Manager::SWITCHER,
                'selectors'  => array(
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'wrapper', 'class', 'nova-table-wrapper' );
        ...
        if ( isset( $settings['responsive_table'] ) && filter_var( $settings['responsive_table'], FILTER_VALIDATE_BOOLEAN ) && ! empty( $settings['responsive_table_on'] ) ) {
            foreach ( $settings['responsive_table_on'] as $device_type ) {
                $this->add_render_attribute( 'wrapper', 'class', 'nova-table-responsive-' . $device_type );
            }
        }

        $this->add_render_attribute( 'table', 'class', 'nova-table' );

        $sorting = ( isset( $settings['sorting_table'] ) && filter_var( $settings['sorting_table'], FILTER_VALIDATE_BOOLEAN ) ) ? true : false;

        if ( $sorting ) {
            $this->add_render_attribute( 'table', 'class', 'nova-table--sorting' );
        }
        ?>

        <div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
            <table <?php echo $this->get_render_attribute_string( 'table' ); ?>>
                <thead class="nova-table__head"><?php echo $this->get_table_cells( $table_head, 'head' ); ?></thead>
                <tbody class="nova-table__body"><?php echo $this->get_table_cells( $table_body, 'body' ); ?></tbody>
            </table>
        </div>
    ...
    public function get_table_cells( $data = array(), $context = 'head' ) {
        ...
        if ( 'head' === $context ) {
            $html .= '<tr class="nova-table__head-row">';
        }
        ...
        foreach ( $data as $index => $item ) {
            if ( isset( $item['action'] ) && 'row' === $item['action'] ) {
                // Render row html
                if ( $is_first_row ) {
                    $html .= sprintf( '<tr class="nova-table__body-row elementor-repeater-item-%s">', esc_attr( $item['_id'] ) );
                    $is_first_row = false;
                } else {
                    $html .= sprintf( '</tr><tr class="nova-table__body-row elementor-repeater-item-%s">', esc_attr( $item['_id'] ) );
                }
            } else {
                // Render cell html
                $additional_content = '';
                ...
                if ( 'icon' === $additional_element && ! empty ( $item['cell_icon'] ) ) {
                    $additional_content = sprintf( '<i class="nova-table__cell-icon nova-table__cell-icon--%2$s %1$s"></i>', esc_attr( $item['cell_icon'] ), esc_attr( $position ) );
                }
                ...
                if ( 'image' === $additional_element && ! empty ( $item['cell_image']['url'] ) ) {
                    ...
                    $additional_content = sprintf( '<div class="nova-table__cell-img nova-table__cell-img--%2$s">%1$s</div>', $image_html, esc_attr( $position ) );
                }

                $cell_text = ! empty( $item['cell_text'] ) ? sprintf( '<div class="nova-table__cell-text">%s</div>', $item['cell_text'] ) : '';

                $cell_content = sprintf( '<div class="nova-table__cell-content">%1$s%2$s</div>', $additional_content, $cell_text );

                $this->add_render_attribute( 'cell-' . $item['_id'], 'class', 'nova-table__cell' );
                ...
                if ( 'head' === $context ) {
                    ...
                    $this->add_render_attribute( 'cell-' . $item['_id'], 'class', 'nova-table__head-cell' );
                    $this->add_render_attribute( 'cell-' . $item['_id'], 'scope', 'col' );

                    $sorting_icon = $sorting ? '<i class="nova-table__sort-icon"></i>' : '';

                    $html .= sprintf( '<th %3$s><div class="nova-table__cell-inner">%1$s%2$s</div></th>', $cell_content, $sorting_icon, $this->get_render_attribute_string( 'cell-' . $item['_id'] ) );
                } else {
                    ...
                    if ( 'th' === $cell_tag ) {
                        ...
                        $this->add_render_attribute( 'cell-' . $item['_id'], 'class', 'nova-table__body-cell' );
                    }

                    $cell_inner_tag = 'div';
                    $this->add_render_attribute( 'cell-inner-' . $item['_id'], 'class', 'nova-table__cell-inner' );

                    if ( ! empty( $item['cell_link']['url'] ) ) {
                        $cell_inner_tag = 'a';
                        $this->add_render_attribute( 'cell-inner-' . $item['_id'], 'class', 'nova-table__cell-link' );
