<?php
namespace Nova_Elements\Modules\Portfolio\Widgets;
 ...
 * Portfolio Widget
 */
class Portfolio extends Nova_Widget {
    ...
    public function get_name() {
        return 'nova-portfolio';
    }

    protected function get_widget_title() {
        return esc_html__( 'Portfolio', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-36';
    }
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            'nova-elements/portfolio/css-scheme',
            array(
                'instance'         => '.nova-portfolio',
                'list_container_wrap'   => '.nova-portfolio__list_wrapper',
                'list_container'   => '.nova-portfolio__list',
                'item'             => '.nova-portfolio__item',
                'inner'            => '.nova-portfolio__inner',
                'image_wrap'       => '.nova-portfolio__image',
                'image_instance'   => '.nova-portfolio__image-instance',
                'content_wrap'     => '.nova-portfolio__content',
                'content_inner'    => '.nova-portfolio__content-inner',
                'cover'            => '.nova-portfolio__cover',
                'title'            => '.nova-portfolio__title',
                'desc'             => '.nova-portfolio__desc',
                'category'         => '.nova-portfolio__category',
                'button'           => '.nova-portfolio__button',
                'view_more'        => '.nova-portfolio__view-more-button',
                'filters_wrap'     => '.nova-portfolio__filter',
                'filters'          => '.nova-portfolio__filter-list',
                'filter'           => '.nova-portfolio__filter-item',
                'filter_separator' => '.nova-portfolio__filter-item-separator',
            )
        );

        $preset_type = apply_filters(
            'nova-elements/portfolio/control/preset',
            array(
                ...
                'type-7' => esc_html__( 'Type-7', 'nova-elements' ),
                'type-8' => esc_html__( 'Type-8', 'nova-elements' )
            )
        );

        $preset_list_type = apply_filters(
            'nova-elements/portfolio/control/preset_list',
            array(
                'list-type-1' => esc_html__( 'Type-1', 'nova-elements' ),
                'list-type-2' => esc_html__( 'Type-2', 'nova-elements' ),
                'list-type-3' => esc_html__( 'Type-3', 'nova-elements' ),
                'list-type-4' => esc_html__( 'Type-4', 'nova-elements' ),
                'list-type-5' => esc_html__( 'Type-5', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'justify' => esc_html__( 'Justify', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Enable Custom Image Height', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_responsive_control(
            'custom_image_height',
            array(
                'label' => esc_html__( 'Image Height', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 100,
        ...
        $this->add_control(
            'all_filter_label',
            array(
                'label'   => esc_html__( '`All` Filter Label', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( 'All', 'nova-elements' ),
                'condition' => array(
                    'layout_type!' => array(
                        'grid',
                        'list'
        ...
        $this->add_control(
            'view_more_button',
            array(
                'label'        => esc_html__( 'View More Button', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'View More Button Text', 'nova-elements' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => esc_html__( 'View More', 'nova-elements' ),
                'condition' => array(
        ...
        $this->add_control(
            'per_page',
            array(
                'label'   => esc_html__( 'Item Per Page', 'nova-elements' ),
         ...
         * @var boolean
         */
        $use_retina = apply_filters( 'nova-elements/portfolio/use-retina-image', false );

        if ( $use_retina ) {
            $repeater->add_control(
                'item_image_2x',
                array(
                    'label'   => esc_html__( 'Retina Image', 'nova-elements' ),
                    'type'    => Controls_Manager::MEDIA,
                    'default' => array(
                        'url' => Utils::get_placeholder_image_src(),
                    ),
        ...
        $repeater->add_control(
            'item_button_text',
            array(
                'label'   => esc_html__( 'Link Text', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'item_button_url',
            array(
                'label'       => esc_html__( 'Link Url', 'nova-elements' ),
            ...
            array(
                ...
                'default'     => array(
                    array(
                        ...
                        'item_title'       => esc_html__( 'Image #1', 'nova-elements' ),
                    ...
                    array(
                        ...
                        'item_title'       => esc_html__( 'Image #2', 'nova-elements' ),
                        'item_desc'        => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'nova-elements' ),
                    ),
                    array(
                        'item_image'       => array(
                        ...
                        'item_title'       => esc_html__( 'Image #3', 'nova-elements' ),
                        'item_desc'        => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'nova-elements' ),
                    ),
                    array(
                        'item_image'       => array(
                        ...
                        'item_title'       => esc_html__( 'Image #4', 'nova-elements' ),
                        'item_desc'        => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'nova-elements' ),
                    ),
                    array(
                        'item_image'       => array(
                        ...
                        'item_title'       => esc_html__( 'Image #5', 'nova-elements' ),
                        'item_desc'        => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'nova-elements' ),
                    ),
                    array(
                        'item_image'       => array(
                        ...
                        'item_title'       => esc_html__( 'Image #6', 'nova-elements' ),
                        'item_desc'        => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'nova-elements' ),
                    ),
                ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Filters', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Filters Container Styles', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Filters Items Styles', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Separator Icon', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Separator Color', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label' => esc_html__( 'Separator Size', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 1,
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'More Button', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
    ...
    public function generate_setting_json() {
        ...
        $mobile_portrait_col = absint( $module_settings['columns_width640'] );
    ...
    protected function __loop_image_item() {
        ...
        return sprintf( '<img class="nova-portfolio__image-instance la-lazyload-image" src="%1$s" data-src="%1$s" width="%2$s" height="%3$s" %4$s alt="">', $params[0], $params[1], $params[2], $srcset );
    }
    ...
    public function render_filters() {
        ...
        $all_label = ( ! empty( $all_label ) ) ? $all_label : esc_html__( 'All', 'nova-elements' );
        $all_label_slug = sanitize_title($all_label);

        $html .= sprintf( '<div class="nova-portfolio__filter-item active" data-slug="%1$s"><span>%2$s</span></div>', $all_label_slug, $all_label );

        if ( ! empty( $separator_icon ) ) {
            $separator_html = sprintf( '<i class="nova-portfolio__filter-item-separator %s"></i>', $separator_icon );
        }

        foreach ( $category_list as $slug => $category_name ) {
            if($slug == $all_label_slug) continue;
            $html .= sprintf( '%3$s<div class="nova-portfolio__filter-item" data-slug="%1$s"><span>%2$s</span></div>', $slug, $category_name, $separator_html );
        }

        echo sprintf( '<div class="nova-portfolio__filter"><div class="nova-portfolio__filter-list">%s</div></div>', $html );
    }
    ...
    public function render_view_more_button() {
        ...
        $this->add_render_attribute( 'view_more_button', 'class', array(
            'elementor-button',
            'elementor-size-md',
            'nova-portfolio__view-more-button',
        ) );

        $format = apply_filters( 'nova-elements/portfolio/more-button-format', '<div class="nova-portfolio__view-more hidden-status"><div %1$s>%2$s</div></div>' );
    ...
    public function __generate_item_button() {
        ...
        $format = apply_filters( 'nova-elements/portfolio/action-button-format', '<a %1$s><span class="nova-portfolio__button-text">%2$s</span></a>' );
    ...
    public function __get_item_category() {
        ...
        if(!empty($category_html)){
            return sprintf( '<p class="nova-portfolio__category">%s</p>', $category_html );
        }
        else{
