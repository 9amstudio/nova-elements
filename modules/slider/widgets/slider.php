...
class Slider extends Nova_Widget {
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            ...
            array(
                'instance'            => '.nova-slider',
                'instance_slider'     => '.nova-slider .slider-pro',
                'navigation'          => '.nova-slider .sp-arrows',
                'pagination'          => '.nova-slider .sp-buttons',
                'icon'                => '.nova-slider__icon',
                'title'               => '.nova-slider__title',
                'subtitle'            => '.nova-slider__subtitle',
                'desc'                => '.nova-slider__desc',
                ...
                'overlay'             => '.nova-slider .sp-image-container:after',
                'fullscreen'          => '.nova-slider .sp-full-screen-button',
                'thumbnails'          => '.nova-slider .sp-thumbnails-container',
                'thumbnail_container' => '.nova-slider .sp-thumbnail-container',
            )
        );
        ...
        $this->add_control(
            'slider_navigation',
            array(
                'label'        => esc_html__( 'Use navigation?', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'slider_pagination',
            array(
                'label'        => esc_html__( 'Use pagination?', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'slider_fullScreen',
            array(
                'label'        => esc_html__( 'Display fullScreen button?', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'slider_shuffle',
            array(
                'label'        => esc_html__( 'Indicates if the slides will be shuffled', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'slider_fade_mode',
            array(
                'label'        => esc_html__( 'Use fade effect?', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'slide_distance',
            array(
                'label' => esc_html__( ' Between Slides Distance', 'nova-elements' ),
        ...
        $this->add_control(
            'thumbnails',
            array(
                'label'        => esc_html__( 'Display thumbnails?', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'thumbnail_width',
            array(
                'label'   => esc_html__( 'Thumbnail width(px)', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 120,
                'min'     => 20,
                'max'     => 300,
        ...
        $this->add_control(
            'thumbnail_height',
            array(
                'label'   => esc_html__( 'Thumbnail height(px)', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 80,
                'min'     => 20,
                'max'     => 300,
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['instance_slider'] . ' .nova-slider__content-inner' => 'max-width: {{SIZE}}{{UNIT}}',
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Image Scale Mode', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'exact',
                'options' => array(
                    'exact'   => esc_html__( 'Cover', 'nova-elements' ),
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'selector' => '{{WRAPPER}} ' . $css_scheme['instance_slider'] . ' .nova-slider__item',
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['instance'] . ' .nova-slider__item'=> 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Navigation', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Arrow Icon', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'   => esc_html__( 'Pagination Container Offset', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'min'     => -500,
                'max'     => 500,
                'step'    => 1,
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Thumbnails', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Thumbnails Container Offset', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'min'     => -500,
                'max'     => 500,
                'step'    => 1,
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Fullscreen', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-slider-icon-inner' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-slider-icon-inner' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-slider-icon-inner',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-slider-icon-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-slider-icon-inner' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Action Button #1', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Action Button #2', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
