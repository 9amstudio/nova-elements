<?php
namespace Nova_Elements\Modules\Timeline\Widgets;
 ...
 * Timeline Widget
 */
class Timeline extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Vertical Timeline', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-38';
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/timeline/css-scheme',
            array(
                'line'               => '.nova-timeline__line',
                'progress'           => '.nova-timeline__line-progress',
                'item'               => '.nova-timeline-item',
        ...
        $this->add_control(
            'animate_cards',
            array(
                'label'        => esc_html__( 'Animate Cards', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'nova-timeline-item--animated',
                'default'      => '',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Horizontal Alignment', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            'horizontal_space',
            array(
                'label'      => esc_html__( 'Horizontal Space', 'nova-elements' ),
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item_point'] => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .nova-timeline--align-left ' . $css_scheme['item_point']   => 'margin-right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .nova-timeline--align-right ' . $css_scheme['item_point']  => 'margin-left: {{SIZE}}{{UNIT}}',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            'vertical_space',
            array(
                'label'      => esc_html__( 'Vertical Space', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    ...
                    '{{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item'] . ':nth-child(odd) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item'] . ':nth-child(even) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop){{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item'] . ':nth-child(odd) ' . $css_scheme['card_arrow'] => 'margin-right:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop){{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item'] . ':nth-child(even) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop) .rtl {{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item'] . ':nth-child(odd) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop) .rtl {{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['item'] . ':nth-child(even) ' . $css_scheme['card_arrow'] => 'margin-right:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .nova-timeline--align-left ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .nova-timeline--align-right ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow'] => 'margin-right:calc( -{{SIZE}}{{UNIT}} / 2 );',
                ),
            )
        );
    ...
    public function _control_section_card_content( $css_scheme ) {
        ...
        $this->add_control(
            'card_arrow_heading',
            array(
                'label'     => esc_html__( 'Card Arrow', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => array(
        ...
        $this->add_responsive_control(
            'card_arrow_offset',
            array(
                'label'      => esc_html__( 'Card Arrow Offset', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                    '%',
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .nova-timeline--align-top ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow']    => 'margin-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .nova-timeline--align-bottom ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow'] => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ),
                'condition'  => array(
                    'vertical_alignment!' => 'middle'
                )
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    ...
                    '{{WRAPPER}} .nova-timeline--align-center ' . $css_scheme['line'] => 'margin-left: calc( {{SIZE}}{{UNIT}} / 2 ); margin-right: calc( {{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .nova-timeline--align-left ' . $css_scheme['line']   => 'margin-left: calc( {{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .nova-timeline--align-right ' . $css_scheme['line']   => 'margin-right: calc( {{SIZE}}{{UNIT}} / 2 );',
                ),
            )
        );
    ...
    public function _control_section_line( $css_scheme ) {
        ...
        $this->add_responsive_control(
            'line_width',
            array(
                'label'      => esc_html__( 'Thickness', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
