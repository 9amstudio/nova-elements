<?php
namespace Nova_Elements\Modules\SubscribeForm\Widgets;
 ...
 */
class Subscribe_Form extends Nova_Widget {
    ...
    public function get_name() {
        return 'nova-subscribe-form';
    }

    protected function get_widget_title() {
        return esc_html__( 'Subscribe', 'nova-elements' );
    }
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            'nova-elements/subscribe-form/css-scheme',
            array(
                'instance'    => '.nova-subscribe-form',
                'input'       => '.nova-subscribe-form__input',
                'submit'      => '.nova-subscribe-form__submit',
                'submit_icon' => '.nova-subscribe-form__submit-icon',
                'message'     => '.nova-subscribe-form__message',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Fields', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'submit_button_text',
            array(
                'label'       => esc_html__( 'Submit Text', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter Submit Button Text', 'nova-elements' ),
                'default'     => esc_html__( 'Subscribe', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'submit_placeholder',
            array(
                'label'       => esc_html__( 'Input Placeholder', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'E-Mail', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Use Additional Fields', 'nova-elements' ),
        ...
        $repeater->add_control(
            'type',
            [
                'label'   => esc_html__( 'Field Type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'fname',
                'options' => [
                    'fname'   => esc_html__( 'First Name', 'nova-elements' ),
                    'lname'   => esc_html__( 'Last Name', 'nova-elements' ),
                    'address' => esc_html__( 'Address', 'nova-elements' ),
                    'phone'   => esc_html__( 'Phone Number', 'nova-elements' ),
                ]
            ]
        );
        ...
        $repeater->add_control(
            'placeholder',
            array(
                'label'   => esc_html__( 'Field Placeholder', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( 'Enter Value', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'type'        => 'fname',
                        'placeholder' => esc_html__( 'First Name', 'nova-elements' ),
                    ],
                    [
                        'type'        => 'lname',
                        'placeholder' => esc_html__( 'Last Name', 'nova-elements' ),
                    ],
                    [
                        'type'        => 'address',
                        'placeholder' => esc_html__( 'Address', 'nova-elements' ),
                    ],
                    [
                        'type'        => 'phone',
                        'placeholder' => esc_html__( 'Phone Number', 'nova-elements' ),
                    ],
                ],
        ...
        $this->add_control(
            'use_redirect_url',
            array(
                'label'        => esc_html__( 'Use Redirect Url?', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'redirect_url',
            array(
                'label'       => esc_html__( 'Redirect Url', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter Redirect Url', 'nova-elements' ),
                'default'     => '#',
                'condition'   => array(
        ...
        $this->add_control(
            'use_target_list_id',
            array(
                'label'        => esc_html__( 'Use Target List Id?', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'target_list_id',
            array(
                'label'     => esc_html__( 'Mailchimp list id', 'nova-elements' ),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'inline',
                'options' => array(
                    'inline' => esc_html__( 'Inline', 'nova-elements' ),
                    'block'  => esc_html__( 'Block', 'nova-elements' ),
                )
            )
        );
        ...
        $this->start_controls_tab(
            'tab_container_error',
            array(
                'label' => esc_html__( 'Error', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} ' . $css_scheme['instance'] . '.nova-subscribe-form--response-error' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}} ' . $css_scheme['instance'] . '.nova-subscribe-form--response-error',
            )
        );
        ...
        $this->start_controls_section(
            'section_input_style',
            array(
                'label'      => esc_html__( 'Input', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Message', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['message'] . ' .nova-subscribe-form__message-inner' => 'justify-content: {{VALUE}};',
                ),
            )
        );
        ...
        $this->start_controls_tab(
            'tab_message_success',
            array(
                'label' => esc_html__( 'Success', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'scheme'   => Scheme_Typography::TYPOGRAPHY_4,
                'selector' => '{{WRAPPER}} .nova-subscribe-form--response-success ' . $css_scheme['message'] . ' span',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'scheme'   => Scheme_Typography::TYPOGRAPHY_4,
                'selector' => '{{WRAPPER}} .nova-subscribe-form--response-error ' . $css_scheme['message'] . ' span',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .nova-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
    ...
    public function generate_additional_fields() {
        ...
        $default_fields_data = [
            'fname' => [
                'class'       => [
                    'nova-subscribe-form__input nova-subscribe-form__fname-field',
                ],
                'type'        => 'text',
                'name'        => 'fname',
                'placeholder' => esc_html__( 'First Name', 'nova-elements' ),
            ...
            'address' => [
                'class'       => [
                    'nova-subscribe-form__input nova-subscribe-form__address-field',
                ],
                'type'        => 'text',
                'name'        => 'address',
                'placeholder' => esc_html__( 'Address', 'nova-elements' )
            ...
            'phone' => [
                'class'       => [
                    'nova-subscribe-form__input nova-subscribe-form__phone-field',
                ],
                'type'        => 'tel',
                'name'        => 'phone',
                'placeholder' => esc_html__( 'Phone Number', 'nova-elements' )
