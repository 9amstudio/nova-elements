<?php
namespace Nova_Elements\Modules\Audio\Widgets;
 ...
 * Audio Widget
 */
class Audio extends Nova_Widget {
    public function get_name() {
        return 'nova-audio';
    }

    protected function get_widget_title() {
        return esc_html__( 'Audio Player', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-40';
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/audio/css-scheme',
            array(
                'play_pause_btn_wrap' => '.nova-audio .mejs-playpause-button',
                'play_pause_btn'      => '.nova-audio .mejs-playpause-button > button',
                'time'                => '.nova-audio .mejs-time',
                'current_time'        => '.nova-audio .mejs-currenttime',
                'duration_time'       => '.nova-audio .mejs-duration',
                'rail_progress'       => '.nova-audio .mejs-time-rail',
                'total_progress'      => '.nova-audio .mejs-time-total',
                'current_progress'    => '.nova-audio .mejs-time-current',
                'volume_btn_wrap'     => '.nova-audio .mejs-volume-button',
                'volume_btn'          => '.nova-audio .mejs-volume-button > button',
                'volume_slider_hor'   => '.nova-audio .mejs-horizontal-volume-slider',
                'total_volume_hor'    => '.nova-audio .mejs-horizontal-volume-total',
                'current_volume_hor'  => '.nova-audio .mejs-horizontal-volume-current',
                'total_volume_vert'   => '.nova-audio .mejs-volume-total',
                'current_volume_vert' => '.nova-audio .mejs-volume-current',
                'volume_slider_vert'  => '.nova-audio .mejs-volume-slider',
                'volume_handle_vert'  => '.nova-audio .mejs-volume-handle',
            )
        );
        ...
        $this->start_controls_section(
            'section_audio',
            array(
                'label' => esc_html__( 'Audio', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'audio_source',
            array(
                'label'   => esc_html__( 'Audio Source', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'self',
                'options' => array(
                    'self'     => esc_html__( 'Self Hosted', 'nova-elements' ),
                    'external' => esc_html__( 'External', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'self_url',
            array(
                'label' => esc_html__( 'URL', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'  => esc_html__( 'Audio Player support MP3 audio format', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Audio Options', 'nova-elements' ),
        ...
        $this->add_control(
            'muted',
            array(
                'label' => esc_html__( 'Muted', 'nova-elements' ),
                'type'  => Controls_Manager::SWITCHER,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Controls Options', 'nova-elements' ),
                'type'  => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'current',
            array(
                'label'   => esc_html__( 'Current Time', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            'duration',
            array(
                'label'   => esc_html__( 'Duration Time', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            'volume',
            array(
                'label'   => esc_html__( 'Volume', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Hide Volume On Touch Devices', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => array(
                    'volume' => 'yes',
        ...
        $this->add_control(
            'volume_bar',
            array(
                'label'   => esc_html__( 'Volume Bar', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
                ...
                'selectors' => array(
                    '{{WRAPPER}} .nova-audio .mejs-volume-slider' => '{{VALUE}}',
                    '{{WRAPPER}} .nova-audio .mejs-horizontal-volume-slider' => '{{VALUE}}',
                ),
                'condition' => array(
                    'volume' => 'yes',
                ),
        ...
        $this->add_control(
            'volume_bar_layout',
            array(
                'label'   => esc_html__( 'Volume Bar Layout', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => array(
        ...
        $this->add_control(
            'start_volume',
            array(
                'label'       => esc_html__( 'Start Volume', 'nova-elements' ),
                'description' => esc_html__( 'Initial volume when the player starts. Override by user cookie.', 'nova-elements' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Play-Pause Button and Time', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Progress', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'progress' => 'yes',
                ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Volume Handle', 'nova-elements' ),
                'type'  => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => array(
                    'volume' => 'yes',
