<?php
namespace Nova_Elements\Modules\Video\Widgets;
 ...
 * Video Widget
 */
class Video extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Video Player', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-41';
    }

    public function get_script_depends() {
        if ( \Nova_Elements\NovaPlugin::instance()->in_elementor() ) {
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/video/css-scheme',
            array(
                'wrapper'        => '.nova-video',
                'overlay'        => '.nova-video__overlay',
                'play_btn'       => '.nova-video__play-button',
                'play_btn_icon'  => '.nova-video__play-button-icon',
                'play_btn_image' => '.nova-video__play-button-image',

                'mejs_controls'            => '.nova-video .mejs-controls',
                'mejs_play_pause_btn_wrap' => '.nova-video .mejs-playpause-button',
                'mejs_play_pause_btn'      => '.nova-video .mejs-playpause-button > button',
                'mejs_time'                => '.nova-video .mejs-time',
                'mejs_current_time'        => '.nova-video .mejs-currenttime',
                'mejs_duration_time'       => '.nova-video .mejs-duration',
                'mejs_rail_progress'       => '.nova-video .mejs-time-rail',
                'mejs_total_progress'      => '.nova-video .mejs-time-total',
                'mejs_current_progress'    => '.nova-video .mejs-time-current',
                'mejs_volume_btn_wrap'     => '.nova-video .mejs-volume-button',
                'mejs_volume_btn'          => '.nova-video .mejs-volume-button > button',
                'mejs_volume_slider_hor'   => '.nova-video .mejs-horizontal-volume-slider',
                'mejs_total_volume_hor'    => '.nova-video .mejs-horizontal-volume-total',
                'mejs_current_volume_hor'  => '.nova-video .mejs-horizontal-volume-current',
                'mejs_fullscreen_btn_wrap' => '.nova-video .mejs-fullscreen-button',
                'mejs_fullscreen_btn'      => '.nova-video .mejs-fullscreen-button > button',
            )
        );
        ...
        $this->add_control(
            'video_type',
            array(
                'label'   => esc_html__( 'Video Type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'youtube',
                'options' => array(
                    'youtube'     => esc_html__( 'YouTube', 'nova-elements' ),
                    'vimeo'       => esc_html__( 'Vimeo', 'nova-elements' ),
                    'self_hosted' => esc_html__( 'Self Hosted', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'youtube_url',
            array(
                'label'       => esc_html__( 'YouTube URL', 'nova-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter your URL', 'nova-elements' ),
        ...
        $this->add_control(
            'vimeo_url',
            array(
                'label'       => esc_html__( 'Vimeo URL', 'nova-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter your URL', 'nova-elements' ),
        ...
        $this->add_control(
            'self_hosted_player',
            array(
                'label'   => esc_html__( 'Player', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'html5',
                'options' => array(
                    'html5' => esc_html__( 'Default HTML5', 'nova-elements' ),
                    'mejs'  => esc_html__( 'MediaElement Player', 'nova-elements' ),
                ),
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'  => esc_html__( 'MediaElement Player support MP4 and WebM video formats', 'nova-elements' ),
        ...
        $this->add_control(
            'self_hosted_url',
            array(
                'label'      => esc_html__( 'Self Hosted URL', 'nova-elements' ),
        ...
        $this->add_control(
            'start_time',
            array(
                'label'       => esc_html__( 'Start Time (in seconds)', 'nova-elements' ),
                'label_block' => true,
        ...
        $this->add_control(
            'end_time',
            array(
                'label'       => esc_html__( 'End Time (in seconds)', 'nova-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::NUMBER,
                'condition' => array(
                    'loop' => '',
        ...
        $this->add_control(
            'aspect_ratio',
            array(
                'label'   => esc_html__( 'Aspect Ratio', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => '16-9',
                'options' => array(
                    '16-9' => '16:9',
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Video Options', 'nova-elements' ),
        ...
        $this->add_control(
            'mute',
            array(
                'label'   => esc_html__( 'Mute', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'loop',
            array(
                'label'   => esc_html__( 'Loop', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'controls',
            array(
                'label'     => esc_html__( 'Player Controls', 'nova-elements' ),
                'type'      => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'yt_modestbranding',
            array(
                'label'     => esc_html__( 'Modest Branding', 'nova-elements' ),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'condition' => array(
                    'video_type' => 'youtube',
        ...
        $this->add_control(
            'yt_info',
            array(
                'label'     => esc_html__( 'Info', 'nova-elements' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__( 'Show', 'nova-elements' ),
                'label_off' => esc_html__( 'Hide', 'nova-elements' ),
                'default'   => '',
        ...
        $this->add_control(
            'yt_suggested_videos',
            array(
                'label'     => esc_html__( 'Suggested Videos', 'nova-elements' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__( 'Show', 'nova-elements' ),
                'label_off' => esc_html__( 'Hide', 'nova-elements' ),
                'default'   => '',
        ...
        $this->add_control(
            'yt_privacy_mode',
            array(
                'label'       => esc_html__( 'Privacy Mode', 'nova-elements' ),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'nova-elements' ),
                'default'     => '',
                'condition'   => array(
                    'video_type' => 'youtube',
                ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Controls Color', 'nova-elements' ),
        ...
        $this->add_control(
            'mejs_controls',
            array(
                'label'       => esc_html__( 'Controls Visibility', 'nova-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::SELECT2,
                'multiple'    => true,
                'options' => array(
                    'current'    => esc_html__( 'Current Time', 'nova-elements' ),
                    'duration'   => esc_html__( 'Duration Time', 'nova-elements' ),
                    'volume'     => esc_html__( 'Volume', 'nova-elements' ),
                    'fullscreen' => esc_html__( 'Fullscreen Button', 'nova-elements' ),
                ),
        ...
        $this->add_control(
            'download_button',
            array(
                'label'       => esc_html__( 'Download Button', 'nova-elements' ),
                'description' => esc_html__( 'If browser supports', 'nova-elements' ),
                'type'        => Controls_Manager::SWITCHER,
                'label_on'    => esc_html__( 'Show', 'nova-elements' ),
                'label_off'   => esc_html__( 'Hide', 'nova-elements' ),
                'default'     => '',
        ...
        $this->add_control(
            'poster',
            array(
                'label' => esc_html__( 'Poster', 'nova-elements' ),
                'type'  => Controls_Manager::MEDIA,
                'condition' => array(
                    'video_type' => 'self_hosted',
                ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Thumbnail Overlay', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'show_thumbnail',
            array(
                'label'   => esc_html__( 'Show Custom Thumbnail', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'thumbnail',
            array(
                'label' => esc_html__( 'Thumbnail', 'nova-elements' ),
                'type'  => Controls_Manager::MEDIA,
                'condition' => array(
                    'show_thumbnail' => 'yes',
                ),
        ...
        $this->add_control(
            'overlay_color',
            array(
                'label' => esc_html__( 'Overlay Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->start_controls_section(
            'section_play_button',
            array(
                'label' => esc_html__( 'Play Button', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'show_play_button',
            array(
                'label' => esc_html__( 'Show Play Button', 'nova-elements' ),
                'type'  => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            'play_button_type',
            array(
                'label'   => esc_html__( 'Play Button Type', 'nova-elements' ),
                'type'    => Controls_Manager::CHOOSE,
                'default' => 'icon',
                'toggle'  => false,
                'options' => array(
                    'icon' => array(
                        'title' => esc_html__( 'Icon', 'nova-elements' ),
                        'icon'  => 'fa fa-play',
                    ),
                    'image' => array(
                        'title' => esc_html__( 'Image', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .elementor-nova-video' => 'max-width: {{SIZE}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .elementor-nova-video' => '{{VALUE}}',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            'play_button_size',
            array(
                'label' => esc_html__( 'Icon/Image Size', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 10,
        ...
        $this->add_control(
            ...
            array(
                'label'      => esc_html__( 'Image Border Radius', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Controls Container', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Play-Pause Button and Time', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Play-Pause Button', 'nova-elements' ),
                'type'  => Controls_Manager::HEADING,
            )
        );
        ...
        $this->add_control(
            'time_heading',
            array(
                'label'     => esc_html__( 'Time', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_responsive_control(
            'current_time_margin',
            array(
                'label'      => esc_html__( 'Current Time Margin', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Duration Time Margin', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Progress', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Total Progress Bar', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Current Progress Bar', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Volume', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Volume Button', 'nova-elements' ),
                'type'  => Controls_Manager::HEADING,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Volume Slider', 'nova-elements' ),
                'type'  => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Total Volume Bar', 'nova-elements' ),
                'type'  => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Current Volume Bar', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Fullscreen Button', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
    ...
    public function get_video_html() {
        ...
        if ( 'self_hosted' === $settings['video_type'] ) {
            ...
            $this->add_render_attribute( 'video_player', 'class', 'nova-video-player' );
            $this->add_render_attribute( 'video_player', 'class', sprintf( 'nova-video-%s-player', esc_attr( $settings['self_hosted_player'] ) ) );
            ...
            if ( filter_var( $settings['show_play_button'], FILTER_VALIDATE_BOOLEAN ) ) {
                $this->add_render_attribute( 'video_player', 'class', 'nova-video-custom-play-button' );
            }
