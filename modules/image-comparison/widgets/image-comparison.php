<?php
namespace Nova_Elements\Modules\ImageComparison\Widgets;
 ...
 */
class Image_Comparison extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Image Comparison', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-29';
    }
    ...
    public function get_style_depends() {
        return array( 'nova-juxtapose-css' );
    }

    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/image-comparison/css-scheme',
            array(
                'instance'         => '.nova-image-comparison__instance',
        ...
        $repeater->add_control(
            'item_before_label',
            array(
                'label'   => esc_html__( 'Before Label', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_after_label',
            array(
                'label'   => esc_html__( 'After Label', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'     => array(
                    array(
                        'item_before_label' => esc_html__( 'Before', 'nova-elements' ),
                        'item_before_image' => array(
                            'url' => Utils::get_placeholder_image_src(),
                        ),
                        'item_after_label' => esc_html__( 'After', 'nova-elements' ),
        ...
        $this->start_controls_tab(
            'tab_label_before',
            array(
                'label' => esc_html__( 'Before', 'nova-elements' ),
            )
        );
        ...
        $this->start_controls_tab(
            'tab_label_after',
            array(
                'label' => esc_html__( 'After', 'nova-elements' ),
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Handle', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Control Width', 'nova-elements' ),
        ...
        $this->add_control(
            'handle_arrow_color',
            array(
                'label' => esc_html__( 'Arrow Color', 'nova-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Handle Divider', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Divider Width', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array( 'px' ),
                'range'      => array(
                    'px' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Divider Color', 'nova-elements' ),
                'type'    => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_responsive_control(
            'starting_position',
            array(
                'label'      => esc_html__( 'Divider Starting Position', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array( '%' ),
                'range'      => array(
                    '%' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Handle Arrow', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
