<?php
namespace Nova_Elements\Modules\CountdownTimer\Widgets;
 ...
 */
class Countdown_Timer extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Countdown Timer', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-9';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'due_date',
            array(
                'label'       => esc_html__( 'Due Date', 'nova-elements' ),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => $default_date,
                'description' => sprintf(
                    esc_html__( 'Date set according to your timezone: %s.', 'nova-elements' ),
        ...
        $this->add_control(
            'show_days',
            array(
                'label'        => esc_html__( 'Days', 'nova-elements' ),
        ...
        $this->add_control(
            'label_days',
            array(
                'label'       => esc_html__( 'Days Label', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Days', 'nova-elements' ),
                'placeholder' => esc_html__( 'Days', 'nova-elements' ),
                'condition'   => array(
                    'show_days'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'show_hours',
            array(
                'label'        => esc_html__( 'Hours', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'nova-elements' ),
                'label_off'    => esc_html__( 'Hide', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'label_hours',
            array(
                'label'       => esc_html__( 'Hours Label', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Hours', 'nova-elements' ),
                'placeholder' => esc_html__( 'Hours', 'nova-elements' ),
                'condition'   => array(
                    'show_hours'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'show_min',
            array(
                'label'        => esc_html__( 'Minutes', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'nova-elements' ),
                'label_off'    => esc_html__( 'Hide', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'label_min',
            array(
                'label'       => esc_html__( 'Minutes Label', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Minutes', 'nova-elements' ),
                'placeholder' => esc_html__( 'Minutes', 'nova-elements' ),
                'condition'   => array(
                    'show_min'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'show_sec',
            array(
                'label'        => esc_html__( 'Seconds', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'nova-elements' ),
                'label_off'    => esc_html__( 'Hide', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'label_sec',
            array(
                'label'       => esc_html__( 'Seconds Label', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Seconds', 'nova-elements' ),
                'placeholder' => esc_html__( 'Seconds', 'nova-elements' ),
                'condition'   => array(
                    'show_sec'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'blocks_sep',
            array(
                'label'       => esc_html__( 'Blocks Separator', 'nova-elements' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => ':',
            )
        ...
        $css_scheme = apply_filters(
            'nova-elements/nova-countdown-timer/css-scheme',
            array(
                'container'  => '.nova-countdown-timer',
                'item'  => '.nova-countdown-timer__item',
                'label' => '.nova-countdown-timer__item-label',
                'value' => '.nova-countdown-timer__item-value',
                'sep'   => '.nova-countdown-timer__separator',
                'digit' => '.nova-countdown-timer__digit',
            )
        );
        ...
        $this->add_control(
            'items_size',
            array(
                'label'   => esc_html__( 'Items Size', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'fixed',
                'options' => array(
                    'auto'  => esc_html__( 'Auto', 'nova-elements' ),
                    'fixed' => esc_html__( 'Fixed', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Labels', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Digits', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'digit_item_heading',
            array(
                'label'     => esc_html__( 'Digit Item Styles', 'nova-elements' ),
        ...
        $this->start_controls_section(
            'section_sep_styles',
            array(
                'label'      => esc_html__( 'Separator Styles', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'sep_font',
            array(
                'label'     => esc_html__( 'Font', 'nova-elements' ),
        ...
        $this->add_control(
            'value_order',
            array(
                'label'   => esc_html__( 'Digit Order', 'nova-elements' ),
        ...
        $this->add_control(
            'label_order',
            array(
                'label'   => esc_html__( 'Label Order', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 2,
                'min'     => 1,
                'max'     => 2,
    ...
    public function date_placeholder() {
        return '<span class="nova-countdown-timer__digit">0</span><span class="nova-countdown-timer__digit">0</span>';
    }
    ...
    public function blocks_separator() {
        ...
        $format = apply_filters(
            'nova-elements/nova-countdown-timer/blocks-separator-format',
            '<div class="nova-countdown-timer__separator">%s</div>'
        );
