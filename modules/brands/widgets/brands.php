<?php
namespace Nova_Elements\Modules\Brands\Widgets;
 ...
 * Brands Widget
 */
class Brands extends Nova_Widget {
    public function get_name() {
        return 'nova-brands';
    }

    protected function get_widget_title() {
        return esc_html__( 'Brands', 'nova-elements' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            array(
                'label' => esc_html__( 'Brands', 'nova-elements' ),
            )
        );
        ...
        $repeater->add_control(
            'item_image',
            array(
                'label'   => esc_html__( 'Company Logo', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_name',
            array(
                'label'   => esc_html__( 'Company Name', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_desc',
            array(
                'label'   => esc_html__( 'Company Description', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_url',
            array(
                'label'   => esc_html__( 'Company URL', 'nova-elements' ),
            ...
            array(
                ...
                'default'     => array(
                    array(
                        ...
                        'item_name'  => esc_html__( 'Company #1', 'nova-elements' ),
                        'item_url'   => array(
                            'url' => '#',
                        ),
                    ),
                    array(
                        ...
                        'item_name'  => esc_html__( 'Company #2', 'nova-elements' ),
                        'item_url'   => array(
                            'url' => '#',
                        ),
                    ),
        ...
        $css_scheme = apply_filters(
            'nova-elements/brands/css-scheme',
            array(
                'list'      => '.brands-list',
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Company Item', 'nova-elements' ),
        ...
        $this->add_control(
            'logo_wrap_style',
            array(
                'label'     => esc_html__( 'Logo Wrapper', 'nova-elements' ),
