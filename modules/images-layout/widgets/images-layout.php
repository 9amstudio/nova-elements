<?php
namespace Nova_Elements\Modules\ImagesLayout\Widgets;
 ...
 */
class Images_Layout extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Images Layout', 'nova-elements' );
    }
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            'nova-elements/images-layout/css-scheme',
            array(
                'instance'          => '.nova-images-layout',
                'list_container'    => '.nova-images-layout__list',
                'item'              => '.nova-images-layout__item',
                'inner'             => '.nova-images-layout__inner',
                'image_wrap'        => '.nova-images-layout__image',
                'image_instance'    => '.nova-images-layout__image-instance',
                'content_wrap'      => '.nova-images-layout__content',
                'icon'              => '.nova-images-layout__icon',
                'title'             => '.nova-images-layout__title',
                'desc'              => '.nova-images-layout__desc',
                'button'            => '.nova-images-layout__button',
            )
        );
        ...
        $this->add_control(
            'justify_height',
            array(
                'label'    => esc_html__( 'Justify Height', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_link_type',
            array(
                'label'   => esc_html__( 'Link type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'lightbox',
                'options' => array(
                    'lightbox' => esc_html__( 'Lightbox', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_url',
            array(
                'label'   => esc_html__( 'External Link', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '#',
                'condition' => array(
        ...
        $repeater->add_control(
            'item_target',
            array(
                'label'        => esc_html__( 'Open external link in new window', 'nova-elements' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-images-layout-icon-inner' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-images-layout-icon-inner' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-images-layout-icon-inner',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-images-layout-icon-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['icon'] . ' .nova-images-layout-icon-inner' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'center',
                'options' => array(
                    'flex-start'    => esc_html__( 'Left', 'nova-elements' ),
                    'center'        => esc_html__( 'Center', 'nova-elements' ),
                    'flex-end'      => esc_html__( 'Right', 'nova-elements' ),
                ),
                'selectors'  => array(
