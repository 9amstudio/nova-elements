...
class Module extends Module_Base {
	...
	const QUERY_CONTROL_ID = 'nova_query';
	...
	public function ajax_posts_control_value_titles( $request ) {
		...
		switch ( $request['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'nova-elements/query_control/get_value_titles/' . $request['filter_type'], [], $request );
		}
	...
	public static function get_query_args( $control_id, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'nova-elements/query_control/get_query_args/current_query', $current_query_vars );
	...
	public function register_ajax_actions( $ajax_manager ) {
		$ajax_manager->register_ajax_action( 'nova_query_control_value_titles', [ $this, 'ajax_posts_control_value_titles' ] );
		$ajax_manager->register_ajax_action( 'nova_panel_posts_control_filter_autocomplete', [ $this, 'ajax_posts_filter_autocomplete' ] );
	}
