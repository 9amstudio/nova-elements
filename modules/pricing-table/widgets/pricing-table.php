<?php
namespace Nova_Elements\Modules\PricingTable\Widgets;
 ...
 */
class Pricing_Table extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Pricing Table', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-4';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( 'Subtitle', 'nova-elements' ),
                'dynamic' => array( 'active' => true ),
            )
        );
        ...
        $this->add_control(
            'featured',
            array(
                'label'        => esc_html__( 'Is Featured?', 'nova-elements' ),
        ...
        $this->add_control(
            'featured_badge',
            array(
                'label'   => esc_html__( 'Featured Badge', 'nova-elements' ),
                'type'    => Controls_Manager::MEDIA,
                'default' => array(
                    'url' => nova_elements_tools()->get_badge_placeholder(),
                ),
                'condition' => array(
                    'featured' => 'yes',
                ),
        ...
        $this->add_control(
            'featured_position',
            array(
                'label'   => esc_html__( 'Featured Position', 'nova-elements' ),
        ...
        $this->add_control(
            'price_prefix',
            array(
                'label'   => esc_html__( 'Price Prefix', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( '$', 'nova-elements' ),
                'dynamic' => array( 'active' => true ),
            )
        );
        ...
        $this->add_control(
            'price',
            array(
                'label'   => esc_html__( 'Price Value', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( '100', 'nova-elements' ),
                'dynamic' => array( 'active' => true ),
            )
        );
        ...
        $this->add_control(
            'price_suffix',
            array(
                'label'   => esc_html__( 'Price Suffix', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( '/per month', 'nova-elements' ),
                'dynamic' => array( 'active' => true ),
            )
        );
        ...
        $this->add_control(
            'price_desc',
            array(
                'label' => esc_html__( 'Price Description', 'nova-elements' ),
        ...
        $this->start_controls_section(
            'section_features',
            array(
                'label' => esc_html__( 'Features', 'nova-elements' ),
            )
        );
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Feature', 'nova-elements' ),
                'dynamic' => array( 'active' => true ),
            )
        );
        ...
        $repeater->add_control(
            'item_included',
            array(
                'label'   => esc_html__( 'Is Included?', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'item-included',
                'options' => array(
                    'item-included'=> esc_html__( 'Included', 'nova-elements' ),
                    'item-excluded' => esc_html__( 'Excluded', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => array(
                    array(
                        'item_text'     => esc_html__( 'Feature #1', 'nova-elements' ),
                        'item_included' => 'item-included',
                    ),
                    array(
                        'item_text'     => esc_html__( 'Feature #2', 'nova-elements' ),
                        'item_included' => 'item-included',
                    ),
                    array(
                        'item_text'     => esc_html__( 'Feature #3', 'nova-elements' ),
                        'item_included' => 'item-excluded',
                    ),
                    array(
                        'item_text'     => esc_html__( 'Feature #4', 'nova-elements' ),
                        'item_included' => 'item-excluded',
                    ),
                ),
        ...
        $this->add_control(
            'button_before',
            array(
                'label'   => esc_html__( 'Text Before Action Button', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( 'Buy', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'button_url',
            array(
                'label'   => esc_html__( 'Button URL', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '#',
                'dynamic' => array(
                    'active' => true,
        ...
        $this->add_control(
            'button_after',
            array(
                'label'   => esc_html__( 'Text After Action Button', 'nova-elements' ),
                'type'    => Controls_Manager::TEXT,
                'default' => '',
            )
        );
        ...
        $css_scheme = apply_filters(
            'nova-elements/pricing-table/css-scheme',
            array(
                'table'         => '.pricing-table',
        ...
        $this->start_controls_section(
            'section_table_style',
            array(
                'label'      => esc_html__( 'Table', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            'table_padding',
            array(
                'label'      => esc_html__( 'Table Padding', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Header', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_responsive_control(
            'header_padding',
            array(
                'label'      => esc_html__( 'Header Padding', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
        ...
        $this->add_group_control(
            ...
            array(
                'name'           => 'icon_style',
                'label'          => esc_html__( 'Icon Style', 'nova-elements' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Pricing', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'price_prefix_style',
            array(
                'label'     => esc_html__( 'Prefix', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'price_prefix_color',
            array(
                'label' => esc_html__( 'Price Prefix Color', 'nova-elements' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => array(
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'    => Controls_Manager::SELECT,
                'options' => nova_elements_tools()->verrtical_align_attr(),
                'default' => 'baseline',
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Prefix Display', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'options' => array(
        ...
        $this->add_control(
            'price_color',
            array(
                'label' => esc_html__( 'Price Color', 'nova-elements' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => array(
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
            'price_suffix_style',
            array(
                'label'     => esc_html__( 'Suffix', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'price_suffix_color',
            array(
                'label' => esc_html__( 'Price Suffix Color', 'nova-elements' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => array(
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Suffix Display', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'options' => array(
                    'inline-block' => esc_html__( 'Inline', 'nova-elements' ),
                    'block'        => esc_html__( 'Block', 'nova-elements' ),
        ...
        $this->add_control(
            'price_desc_color',
            array(
                'label' => esc_html__( 'Price Description Color', 'nova-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_responsive_control(
            'price_padding',
            array(
                'label'      => esc_html__( 'Pricing Block Padding', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
        ...
        $this->add_responsive_control(
            'features_padding',
            array(
                'label'      => esc_html__( 'Features Block Padding', 'nova-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Included Feature', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Included Bullet Icon', 'nova-elements' ),
                'type'        => Controls_Manager::ICON,
                'label_block' => true,
                'file'        => '',
                'default'     => 'fa fa-check',
        ...
        $this->add_control(
            'inc_bullet_color',
            array(
                'label' => esc_html__( 'Bullet Color', 'nova-elements' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => array(
                    'type'  => Scheme_Color::get_type(),
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Excluded Feature', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'       => esc_html__( 'Excluded Bullet Icon', 'nova-elements' ),
                'type'        => Controls_Manager::ICON,
                'label_block' => true,
                'file'        => '',
                'default'     => 'fa fa-times',
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'line-through' => esc_html__( 'Line Through', 'nova-elements' ),
                ),
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Features Divider', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Action Box', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'full'  => esc_html__( 'full', 'nova-elements' ),
                ),
            )
        );
