<?php
namespace Nova_Elements\Modules\InstagramGallery\Widgets;
 ...
 */
class Instagram_Gallery extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Instagram', 'nova-elements' );
    }
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            'nova-elements/instagram-gallery/css-scheme',
            array(
                'instance'       => '.nova-instagram-gallery__instance',
                'image_instance' => '.nova-instagram-gallery__image',
                'inner'          => '.nova-instagram-gallery__inner',
                'content'        => '.nova-instagram-gallery__content',
                'caption'        => '.nova-instagram-gallery__caption',
                'meta'           => '.nova-instagram-gallery__meta',
                'meta_item'      => '.nova-instagram-gallery__meta-item',
                'meta_icon'      => '.nova-instagram-gallery__meta-icon',
                'meta_label'     => '.nova-instagram-gallery__meta-label',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Instagram Settings', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'endpoint',
            array(
                'label'   => esc_html__( 'What to display', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'hashtag',
                'options' => array(
                    'hashtag'  => esc_html__( 'Tagged Photos', 'nova-elements' ),
                    'self'     => esc_html__( 'My Photos', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'hashtag',
            array(
                'label' => esc_html__( 'Hashtag (enter without `#` symbol)', 'nova-elements' ),
        ...
        if ( ! $this->get_access_token() ) {
            $this->add_control(
                ...
                array(
                    ...
                    'raw'  => sprintf(
                        esc_html__( 'Please set Instagram Access Token on the %1$s.', 'nova-elements' ),
                        '<a target="_blank" href="#">' . esc_html__( 'settings page', 'nova-elements' ) . '</a>'
                    ),
                    'condition' => array(
                        'endpoint' => 'self',
                    ),
        ...
        $this->add_control(
            'cache_timeout',
            array(
                'label'   => esc_html__( 'Cache Timeout', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'hour',
                'options' => array(
                    'none'   => esc_html__( 'None', 'nova-elements' ),
                    'minute' => esc_html__( 'Minute', 'nova-elements' ),
                    'hour'   => esc_html__( 'Hour', 'nova-elements' ),
                    'day'    => esc_html__( 'Day', 'nova-elements' ),
                    'week'   => esc_html__( 'Week', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'photo_size',
            array(
                'label'   => esc_html__( 'Photo Size', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'high',
                'options' => array(
                    'thumbnail' => esc_html__( 'Thumbnail (150x150)', 'nova-elements' ),
                    'low'       => esc_html__( 'Low (320x320)', 'nova-elements' ),
                    'standard'  => esc_html__( 'Standard (640x640)', 'nova-elements' ),
                    'high'      => esc_html__( 'High (original)', 'nova-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'posts_counter',
            array(
                'label'   => esc_html__( 'Number of instagram posts', 'nova-elements' ),
        ...
        $this->add_control(
            'post_link',
            array(
                'label'        => esc_html__( 'Enable linking photos', 'nova-elements' ),
        ...
        $this->add_control(
            'post_caption',
            array(
                'label'        => esc_html__( 'Enable caption', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'post_caption_length',
            array(
                'label'   => esc_html__( 'Caption length', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 50,
                'min'     => 1,
                'max'     => 300,
        ...
        $this->add_control(
            'post_comments_count',
            array(
                'label'        => esc_html__( 'Enable Comments Count', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'post_likes_count',
            array(
                'label'        => esc_html__( 'Enable Likes Count', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'section_settings',
            array(
                'label' => esc_html__( 'Layout Settings', 'nova-elements' ),
            )
        );
        ...
        $this->add_control(
            'layout_type',
            array(
                'label'   => esc_html__( 'Layout type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'masonry',
                'options' => array(
        ...
        $this->add_responsive_control(
            'item_margin',
            array(
                'label' => esc_html__( 'Items Margin', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 0,
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Caption', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_responsive_control(
            'caption_width',
            array(
                'label' => esc_html__( 'Caption Width', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px', 'em', '%',
                ),
        ...
        $this->add_control(
            'comments_icon',
            array(
                'label'       => esc_html__( 'Comments Icon', 'nova-elements' ),
        ...
        $this->add_control(
            'likes_icon',
            array(
                'label'       => esc_html__( 'Likes Icon', 'nova-elements' ),
                'type'        => Controls_Manager::ICON,
                'label_block' => true,
                'file'        => '',
                'default'     => 'fa fa-heart',
        ...
        $this->add_control(
            'show_on_hover',
            array(
                'label'        => esc_html__( 'Show on hover', 'nova-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'nova-elements' ),
                'label_off'    => esc_html__( 'No', 'nova-elements' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'section_order_style',
            array(
                'label'      => esc_html__( 'Content Order and Alignment', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'caption_order',
            array(
                'label'   => esc_html__( 'Caption Order', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 1,
                'min'     => 1,
                'max'     => 4,
        ...
        $this->add_control(
            'meta_order',
            array(
                'label'   => esc_html__( 'Meta Order', 'nova-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 2,
                'min'     => 1,
                'max'     => 4,
        ...
        $this->add_control(
            'cover_alignment',
            array(
                'label'   => esc_html__( 'Cover Content Vertical Alignment', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'center',
                'options' => array(
    ...
    public function render_gallery() {
        ...
        if ( 'hashtag' === $settings['endpoint'] && empty( $settings['hashtag'] ) ) {
            return print esc_html__( 'Please, enter #hashtag.', 'nova-elements' );
        }

        if ( 'self' === $settings['endpoint'] && ! $this->get_access_token() ) {
            return print esc_html__( 'Please, enter Access Token.', 'nova-elements' );
        }
        ...
        if ( ! empty( $posts ) ) {
            ...
            foreach ( $posts as $post_data ) {
                ...
                $item_html = sprintf(
                    '<div class="nova-instagram-gallery__media">%1$s</div><div class="nova-instagram-gallery__content">%2$s%3$s</div>',
                    $the_image,
                    $the_caption,
                    $the_meta
                );
                ...
                if ( $this->config['post_link'] ) {
                    $link_format = '<a class="nova-instagram-gallery__link" href="%s" target="_blank" rel="nofollow">%s</a>';
                    $link_format = apply_filters( 'nova-elements/instagram-gallery/link-format', $link_format );
            ...
            $html .= sprintf(
                '<div class="nova-instagram-gallery__item">%s</div>',
                esc_html__( 'Posts not found', 'nova-elements' )
            );
        }
    ...
    public function the_image( $item ) {
        ...
        $photo_format = "<img class='nova-instagram-gallery__image' src='%s' width='{$width}' height='{$height}' alt=''>";

        $photo_format = apply_filters( 'nova-elements/instagram-gallery/photo-format', $photo_format );
    ...
    public function the_caption( $item ) {
        ...
        $format = apply_filters(
            'nova-elements/instagram-gallery/the-caption-format', '<div class="nova-instagram-gallery__caption">%s</div>'
        );
    ...
    public function the_meta( $item ) {
        ...
        if ( $this->config['post_comments_count'] ) {
            $meta_html .= sprintf(
                '<div class="nova-instagram-gallery__meta-item nova-instagram-gallery__comments-count"><span class="nova-instagram-gallery__comments-icon nova-instagram-gallery__meta-icon"><i class="%s"></i></span><span class="nova-instagram-gallery__comments-label nova-instagram-gallery__meta-label">%s</span></div>',
        ...
        if ( $this->config['post_likes_count'] ) {
            $meta_html .= sprintf(
                '<div class="nova-instagram-gallery__meta-item nova-instagram-gallery__likes-count"><span class="nova-instagram-gallery__likes-icon nova-instagram-gallery__meta-icon"><i class="%s"></i></span><span class="nova-instagram-gallery__likes-label nova-instagram-gallery__meta-label">%s</span></div>',
                $this->get_settings_for_display( 'likes_icon' ),
                $item['likes']
            );
        }

        $format = apply_filters( 'nova-elements/instagram-gallery/the-meta-format', '<div class="nova-instagram-gallery__meta">%s</div>' );
    ...
    public function get_tags_url() {
        return apply_filters( 'nova-elements/instagram-gallery/get-tags-url', $this->api_url . 'explore/tags/%s/' );
    }
    ...
    public function get_self_url() {
        return apply_filters( 'nova-elements/instagram-gallery/get-self-url', $this->official_api_url . 'users/self/media/recent/' );
    }
    ...
    public function get_post_url() {
        return apply_filters( 'nova-elements/instagram-gallery/get-post-url', $this->api_url . 'p/%s/' );
    }
    ...
    public function _get_relation_photo_size( $photo_size ) {
        ...
        return apply_filters( 'nova-elements/instagram-gallery/relation-photo-size', $size, $photo_size );
    }
    ...
    public function get_transient_key() {
        return sprintf( 'nova_elements_instagram_%s_%s_posts_count_%s_caption_%s',
