<?php
namespace Nova_Elements\Modules\PriceList\Widgets;
 ...
 * Price_List Widget
 */
class Price_List extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Price List', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-39';
    }

    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/price-list/css-scheme',
            array(
                'price_list'       => '.nova-price-list',
                'item'             => '.nova-price-list .price-list__item',
                'item_inner'       => '.nova-price-list .price-list__item-inner',
                'item_title'       => '.nova-price-list .price-list__item-title',
                'item_price'       => '.nova-price-list .price-list__item-price',
                'item_description' => '.nova-price-list .price-list__item-desc',
                'item_separator'   => '.nova-price-list .price-list__item-separator',
                'item_image_wrap'  => '.nova-price-list .price-list__item-img-wrap',
            )
        );
            ...
            array(
                ...
                'default'     => array(
                    array(
                        ...
                        'item_price' => esc_html__( '$12', 'nova-elements' ),
        ...
        $this->add_responsive_control(
            'item_space_between',
            array(
                'label'      => esc_html__( 'Space Between Items (px)', 'nova-elements' ),
        ...
        $this->add_control(
            'first_item_heading',
            array(
                'label'     => esc_html__( 'First Item', 'nova-elements' ),
        ...
        $this->add_control(
            'last_item_heading',
            array(
                'label'     => esc_html__( 'Last Item', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_responsive_control(
            'price_min_width',
            array(
                'label'      => esc_html__( 'Price Minimal Width (px)', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Separator', 'nova-elements' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Separator Type', 'nova-elements' ),
                ...
                'options'   => array(
                    ...
                    'groove' => esc_html__( 'Groove', 'nova-elements' ),
                ),
                'selectors' => array(
        ...
        $this->add_responsive_control(
            ...
            array(
                'label'      => esc_html__( 'Separator Width', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
        ...
        $this->add_responsive_control(
            'image_offset',
            array(
                'label'      => esc_html__( 'Image Offset (px)', 'nova-elements' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
