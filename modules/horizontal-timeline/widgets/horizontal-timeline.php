<?php
namespace Nova_Elements\Modules\HorizontalTimeline\Widgets;
 ...
 */
class Horizontal_Timeline extends Nova_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Horizontal Timeline', 'nova-elements' );
    }

    public function get_icon() {
        return 'novaelements-icon-45';
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'nova-elements/horizontal-timeline/css-scheme',
            array(
                'track'              => '.nova-hor-timeline-track',
                'line'               => '.nova-hor-timeline__line',
                'progress'           => '.nova-hor-timeline__line-progress',
                'item'               => '.nova-hor-timeline-item',
                'item_point'         => '.nova-hor-timeline-item__point',
                'item_point_content' => '.nova-hor-timeline-item__point-content',
                'item_meta'          => '.nova-hor-timeline-item__meta',
                'card'               => '.nova-hor-timeline-item__card',
                'card_inner'         => '.nova-hor-timeline-item__card-inner',
                'card_img'           => '.nova-hor-timeline-item__card-img',
                'card_title'         => '.nova-hor-timeline-item__card-title',
                'card_desc'          => '.nova-hor-timeline-item__card-desc',
                'card_arrow'         => '.nova-hor-timeline-item__card-arrow',
                'arrow'              => '.nova-hor-timeline .nova-arrow',
                'prev_arrow'         => '.nova-hor-timeline .nova-arrow.nova-prev-arrow',
                'next_arrow'         => '.nova-hor-timeline .nova-arrow.nova-next-arrow',
            )
        );
        ...
        $repeater->add_control(
            'show_item_image',
            array(
                'label'   => esc_html__( 'Show Image', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $repeater->add_control(
            'item_point',
            array(
                'label'     => esc_html__( 'Point', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_point_type',
            array(
                'label'   => esc_html__( 'Point Content Type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'icon',
                'options' => array(
                    'icon' => esc_html__( 'Icon', 'nova-elements' ),
                    'text' => esc_html__( 'Text', 'nova-elements' ),
                ),
            )
        );
        ...
        $repeater->add_control(
            'item_point_icon',
            array(
                'label'       => esc_html__( 'Point Icon', 'nova-elements' ),
        ...
        $repeater->add_control(
            'item_point_text',
            array(
                'label'     => esc_html__( 'Point Text', 'nova-elements' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => 'A',
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'     => array(
                    array(
                        'is_item_active'  => 'yes',
                        'item_title'      => esc_html__( 'Card #1', 'nova-elements' ),
                        'item_title_icon' => 'fa fa-birthday-cake',
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'nova-elements' ),
                        'item_point_icon' => 'fa fa-calendar',
                        'item_meta'       => esc_html__( 'Thursday, August 31, 2018', 'nova-elements' ),
                    ),
                    array(
                        'item_title'      => esc_html__( 'Card #2', 'nova-elements' ),
                        'item_title_icon' => 'fa fa-birthday-cake',
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'nova-elements' ),
                        'item_point_icon' => 'fa fa-calendar',
                        'item_meta'       => esc_html__( 'Thursday, August 29, 2018', 'nova-elements' ),
                    ),
                    array(
                        'item_title'      => esc_html__( 'Card #3', 'nova-elements' ),
                        'item_title_icon' => 'fa fa-birthday-cake',
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'nova-elements' ),
                        'item_point_icon' => 'fa fa-calendar',
                        'item_meta'       => esc_html__( 'Thursday, August 28, 2018', 'nova-elements' ),
                    ),
                    array(
                        'item_title'      => esc_html__( 'Card #4', 'nova-elements' ),
                        'item_title_icon' => 'fa fa-birthday-cake',
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'nova-elements' ),
                        'item_point_icon' => 'fa fa-calendar',
                        'item_meta'       => esc_html__( 'Thursday, August 27, 2018', 'nova-elements' ),
                    ),
                ),
        ...
        $this->add_control(
            'show_card_arrows',
            array(
                'label'   => esc_html__( 'Show Card Arrows', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'chess' => array(
                        'title' => esc_html__( 'Chess', 'nova-elements' ),
        ...
        $this->add_control(
            'navigation_type',
            array(
                'label'   => esc_html__( 'Navigation Type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'scroll-bar',
                'options' => array(
                    'scroll-bar' => esc_html__( 'Scroll Bar', 'nova-elements' ),
                    'arrows-nav' => esc_html__( 'Arrows Navigation', 'nova-elements' ),
                )
            )
        );
        ...
        $this->add_control(
            'arrow_type',
            array(
                'label'   => esc_html__( 'Arrow Type', 'nova-elements' ),
                'type'    => Controls_Manager::SELECT,
        ...
        $this->add_responsive_control(
            'items_gap',
            array(
                'label' => esc_html__( 'Items Gap', 'nova-elements' ),
        ...
        $this->start_controls_section(
            'section_cards_style',
            array(
                'label' => esc_html__( 'Cards', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .nova-hor-timeline-list--top ' . $css_scheme['card'] => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .nova-hor-timeline-list--bottom ' . $css_scheme['card'] => 'margin-top: {{SIZE}}{{UNIT}};',
                ),
                'separator' => 'after'
            )
        );
        ...
        $this->add_control(
            'cards_arrow_heading',
            array(
                'label'     => esc_html__( 'Arrow', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => array(
        ...
        $this->add_responsive_control(
            'cards_arrow_width',
            array(
                'label' => esc_html__( 'Size', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .nova-hor-timeline--align-left ' . $css_scheme['card_arrow'] => 'left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .nova-hor-timeline--align-right ' . $css_scheme['card_arrow'] => 'right: {{SIZE}}{{UNIT}};',
                ),
                'condition' => array(
                    'show_card_arrows' => 'yes',
        ...
        $this->start_controls_section(
            'section_image_style',
            array(
                'label' => esc_html__( 'Cards Content', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_control(
            'image_stretch',
            array(
                'label'   => esc_html__( 'Stretch Image', 'nova-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
                'selectors'  => array(
        ...
        $this->add_control(
            'orders_heading',
            array(
                'label'     => esc_html__( 'Orders', 'nova-elements' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'image_order',
            array(
                'label' => esc_html__( 'Image Order', 'nova-elements' ),
                'type'  => Controls_Manager::NUMBER,
                'min'   => 0,
                'max'   => 10,
                'selectors' => array(
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .nova-hor-timeline-list--top ' . $css_scheme['item_meta'] => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .nova-hor-timeline-list--bottom ' . $css_scheme['item_meta'] => 'margin-top: {{SIZE}}{{UNIT}};',
                ),
                'separator' => 'after'
            )
        );
        ...
        $this->add_responsive_control(
            'point_size',
            array(
                'label' => esc_html__( 'Point Size', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .nova-hor-timeline--align-left ' . $css_scheme['item_point_content'] => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .nova-hor-timeline--align-right ' . $css_scheme['item_point_content'] => 'margin-right: {{SIZE}}{{UNIT}};',
                ),
                'condition' => array(
                    'horizontal_alignment!' => 'center',
                ),
        ...
        $this->start_controls_section(
            'section_line_style',
            array(
                'label' => esc_html__( 'Line', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Line Color', 'nova-elements' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
...
//			array(
//				'label'     => esc_html__( 'Progress Color', 'nova-elements' ),
//				'type'      => Controls_Manager::COLOR,
//				'selectors' => array(
...
//		);
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Scrollbar', 'nova-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'  => esc_html__( 'Currently works only in -webkit- browsers', 'nova-elements' ),
        ...
        $this->add_control(
            'scrollbar_bg',
            array(
                'label'     => esc_html__( 'Scrollbar Color', 'nova-elements' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            'scrollbar_thumb_bg',
            array(
                'label'     => esc_html__( 'Scrollbar Thumb Color', 'nova-elements' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            'scrollbar_height',
            array(
                'label' => esc_html__( 'Scrollbar Height', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 1,
        ...
        $this->add_control(
            'scrollbar_offset',
            array(
                'label' => esc_html__( 'Scrollbar Offset', 'nova-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 0,
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'label'    => esc_html__( 'Arrows Style', 'nova-elements' ),
                'selector' => '{{WRAPPER}} ' . $css_scheme['arrow'] . ':not(.nova-arrow-disabled):hover',
            )
        );
    ...
    public function __render_image( $item_settings ) {
        ...
        $image_format = apply_filters( 'nova-elements/horizontal-timeline/image-format', '<div class="nova-hor-timeline-item__card-img">%s</div>' );

        printf( $image_format, $img_html );
    }

    public function __render_point_content( $item_settings ) {
        echo '<div class="nova-hor-timeline-item__point">';
        echo '<div class="nova-hor-timeline-item__point-content">';
