...
if ( ! class_exists( 'Nova_Elements_Utility' ) ) {

	/**
	 * Define Nova_Elements_Tools class
	 */
	class Nova_Elements_Utility {
        ...
        public function get_image( $args = array(), $type = 'post', $id = 0 ) {
            ...
            $default_args = array(
                'visible'                => true,
                'size'                   => apply_filters( 'nova_normal_image_size', 'post-thumbnail' ),
                'mobile_size'            => apply_filters( 'nova_mobile_image_size', 'post-thumbnail' ),
        ...
        public function get_placeholder_url( $args = array() ) {
             ...
             */
            return apply_filters( 'nova_utility_placeholder_image_url', esc_url( $image_url ), $args );
        }
        ...
        public function get_video( $args = array(), $id = 0 ) {
            ...
            $default_args = array(
                'visible'		=> true,
                'size'			=> apply_filters( 'nova_normal_video_size', 'post-thumbnail' ),
                'mobile_size'	=> apply_filters( 'nova_mobile_video_size', 'post-thumbnail' ),
                'class'			=> 'wp-video',
                'echo'			=> false,
            );
            $args = wp_parse_args( $args, $default_args );
...
/**
 * Returns instance of Nova_Elements_Utility
 *
 * @return object
 */
function nova_elements_utility() {
	return Nova_Elements_Utility::get_instance();
}
