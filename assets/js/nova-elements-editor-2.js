( function( $ ) {
	...
	$(window).on('load', function () {
			...
			var _html = '<div class="elementor-panel-footer-sub-menu-item" data-device-mode="laptop"><i class="elementor-icon eicon-laptop" aria-hidden="true"></i><span class="elementor-title">'+ NovaCustomBPFE.laptop.name +'</span><span class="elementor-description">'+NovaCustomBPFE.laptop.text+'</span></div>';
				_html += '<div class="elementor-panel-footer-sub-menu-item" data-device-mode="tablet"><i class="elementor-icon eicon-device-tablet landscape" aria-hidden="true"></i><span class="elementor-title">'+NovaCustomBPFE.tablet.name+'</span><span class="elementor-description">'+NovaCustomBPFE.tablet.text+'</span></div>',
				_html += '<div class="elementor-panel-footer-sub-menu-item" data-device-mode="width800"><i class="elementor-icon eicon-device-width800" aria-hidden="true"></i><span class="elementor-title">'+NovaCustomBPFE.width800.name+'</span><span class="elementor-description">'+NovaCustomBPFE.width800.text+'</span></div>';
