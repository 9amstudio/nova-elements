...
abstract class Base extends Base_File {
	...
	protected function parse_content() {
        ...
        return apply_filters('nova-elements/custom-widget-css/parse_content', $this->stylesheet_obj->__toString());
	}
	...
	private function init_stylesheet() {
		...
		$this->stylesheet_obj
            ->add_device( 'width640',  0)
			->add_device( 'mobile', $breakpoints['width640'] )
            ->add_device( 'width800', $breakpoints['md'] )
			->add_device( 'tablet', $breakpoints['width800'] )
