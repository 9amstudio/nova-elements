...
$link_css_class = array('nova-images-layout__link');
...
<article <?php echo $this->get_render_attribute_string( $item_instance ); ?>>
	<div class="nova-portfolio__inner">
		<a <?php echo $this->get_render_attribute_string( $link_instance ); ?>>
			<div class="nova-portfolio__image" style="background-image: url('<?php echo esc_url($item_image_url); ?>')">
				<?php echo $this->__loop_image_item(); ?>
				<div class="nova-portfolio__image-loader"><span></span></div>
			</div>
		</a>
		<div class="nova-portfolio__content">
			<div class="nova-portfolio__content-inner">
                <div class="nova-portfolio__content-inner2"><?php
				$title_tag = $this->__get_html( 'title_html_tag', '%s' );
				echo $this->__loop_item( array( 'item_title' ), '<' . $title_tag . ' class="nova-portfolio__title">%s</' . $title_tag . '>' );
				echo $this->__get_item_category();
				echo $this->__loop_item( array( 'item_desc' ), '<p class="nova-portfolio__desc">%s</p>' );
