...
<div class="<?php echo $classes; ?>">
	<div class="nova-services__inner">
		<div class="nova-services__header">
			<div class="nova-services__cover"><?php
		...
		<div class="nova-services__content"><?php
