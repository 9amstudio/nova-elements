...
$this->add_render_attribute( 'wrapper', 'class',
	array(
		'nova-hor-timeline',
		'nova-hor-timeline--layout-' . esc_attr( $settings['vertical_layout'] ),
		'nova-hor-timeline--align-' . esc_attr( $settings['horizontal_alignment'] ),
		'nova-hor-timeline--' . esc_attr( $settings['navigation_type'] ),
	)
);
...
<div <?php $this->print_render_attribute_string( 'wrapper' ) ?>>
	<div class="nova-hor-timeline-inner">
		<div class="nova-hor-timeline-track">
	...
	<?php
		if ( 'arrows-nav' === $settings['navigation_type'] ) {
			echo nova_elements_tools()->get_carousel_arrow( array( $settings['arrow_type'], 'nova-prev-arrow nova-arrow-disabled' ) );
			echo nova_elements_tools()->get_carousel_arrow( array( $settings['arrow_type'], 'nova-next-arrow' ) );
		}
	?>
</div>