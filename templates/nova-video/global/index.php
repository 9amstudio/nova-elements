...
$this->add_render_attribute( 'wrapper', 'class', 'nova-video' );
$this->add_render_attribute( 'wrapper', 'data-settings', esc_attr( json_encode( $data_settings ) ) );

if ( ! empty( $settings['aspect_ratio'] ) ) {
	$this->add_render_attribute( 'wrapper', 'class', 'nova-video-aspect-ratio' );
	$this->add_render_attribute( 'wrapper', 'class', 'nova-video-aspect-ratio--' . esc_attr( $settings['aspect_ratio'] ) );
}
?>
