 ...
 * @since 0.0.1
 */
abstract class Nova_Widget extends Widget_Base {
    ...
    public function get_title(){
        return 'Nova ' . $this->get_widget_title();
    }
    ...
    public function __get_global_template( $name = null ) {
        ...
        if ( ! $template ) {
            $template = nova_elements_get_template( $this->get_name() . '/global/' . $name . '.php' );
        }
    ...
    public function __get_render_template( $name = null ) {
        return nova_elements_get_template( $this->get_name() . '/render/' . $name . '.php' );
    }
    ...
    public function __get_edit_template( $name = null ) {
        return nova_elements_get_template( $this->get_name() . '/edit/' . $name . '.php' );
    }
    ...
    public function __get_render_looped_template( $templates = array(), $setting = null ) {
        ...
        $loop = apply_filters( 'nova-elements/widget/loop-items', $loop, $setting, $this );
    ...
    public function __open_wrap() {
        printf( '<div class="elementor-%s nova-elements">', $this->get_name() );
    }
